        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          ...
          <div className="xl:col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Email Card */}
              <div className="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-slate-100 hover:border-blue-200">
                <div className="bg-blue-100 p-4 rounded-lg group-hover:scale-110 transition-transform duration-300 w-[60px] mb-4">
                ...
                <div className="space-y-2">
                  <a href="mailto:support@kawempelibrary.ac.ug" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-lg transition-colors duration-200 group-hover:translate-x-1 transform transition-transform">
                    support@kawempelibrary.ac.ug
                    <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                  </a>
                  <p className="text-sm text-slate-500">Typically respond within 2-4 hours</p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-slate-100 hover:border-blue-200">
                ...
                <div className="space-y-2">
                  <a href="tel:+256700123456" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-lg transition-colors duration-200 group-hover:translate-x-1 transform transition-transform">
                    +256 700 123 456
                    <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
              ...
              <div className="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-slate-100 hover:border-blue-200">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">Technical Help</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  Experiencing issues with the platform? Our tech team is here to help you.
                </p>
                <div className="space-y-2">
                  <a href="mailto:tech@kawempelibrary.ac.ug" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-lg transition-colors duration-200 group-hover:translate-x-1 transform transition-transform">
                    tech@kawempelibrary.ac.ug
                    <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                  </a>
                  <p className="text-sm text-slate-500">24/7 for critical platform issues</p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-slate-100 hover:border-blue-200">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">Visit Our Office</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <CounterCard label="Satisfaction Rate" colorClass="text-blue-600">
                <Counter target={98} suffix="%" duration={1200} />
              </CounterCard>

              <CounterCard label="Students Helped" colorClass="text-blue-600">
                <Counter target={2500} formatComma appendPlus duration={1400} />
              </CounterCard>

              <CounterCard label="Quick Issue Resolution" colorClass="text-blue-600">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-600 rounded-xl shadow-lg p-6 text-white">
              ...
              <a href="tel:+256700654321" className="inline-flex items-center justify-center w-full bg-white text-red-600 font-bold py-3 px-4 rounded-lg hover:bg-red-50 transition-colors duration-200">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <a key={index} href={item.href} className="flex items-center p-3 rounded-lg hover:bg-blue-50 transition-colors duration-200 group">
                    ...
                    <span className="text-slate-700 group-hover:text-blue-600 font-medium flex-1">{item.name}</span>
                    <svg className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {[
                  ...
                  <div key={index} className="flex justify-between items-center py-2 border-b border-slate-700 last:border-0">
                    ...
                    <span className={`font-medium ${
                      ...
                      schedule.status === 'limited' ? 'text-blue-400' : 'text-slate-400'
                    }`}>
                      {schedule.time}
                    </span>
                  </div>
